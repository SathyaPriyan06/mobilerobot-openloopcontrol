...
if __name__ == '__main__':
    ...
    ep_chassis.move(x=0.4, y=0, z=74, xy_speed=1).wait_for_completed()
    ...
    ep_chassis.move(x=0, y=0, z=36, xy_speed=1).wait_for_completed()
    ep_led.set_led(comp = "all",r=255,g=0,b=255,effect="on")
...
https://youtu.be/BsRfajNekR8?si=JZbZcrXmkOdl_r_H
